...
- [ ] Update the "Fixed" section of CHANGELOG.md to add an entry for the `scripts/check_todo_format.sh` fix that makes it also check the last line of the checklist file when that file doesn't end with a trailing newline, which was added in a prior commit but is currently undocumented in the changelog
